  ...
  <nav class="navbar fixed-top navbar-light bg-white topnav px-2 py-0" style="height: 108px;">
   <div class="col-3">
    ...
    <div class="col-6 text-center px-0">
      ...
      <b class="text_shadow">{{auth()->guard('custodian')->user()->name}}</b></h4>
    </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" style="height: 57px">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item px-2 py-1">
              <a href="{{ route('custodian.logout') }}" id="logout_a"><span class="badge badge-dark p-2" title="logout"><i class="fas fa-power-off"></i></span>
              </a>
              <form id="logout-form" action="{{ route('custodian.logout') }}" method="POST" style="display: none;">
