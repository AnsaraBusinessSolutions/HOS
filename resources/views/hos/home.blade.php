...
$(function() {
    ...
    $('#addRow').on( 'click', function () {
      table.row.add( [
            '<td>'+counter+'</td>',
            '<td><input type="text" data-row_id ="'+counter+'" data-name="nupco_material_generic_code" id="nupco_material_generic_code_'+counter+'" name="nupco_material_generic_code[]"></td>',
            '<td><input type="text" data-row_id ="'+counter+'" data-name="customer_bp" id="customer_bp_'+counter+'" name="customer_bp[]"></td>',
            '<td><input type="text" data-row_id ="'+counter+'" data-name="material_description" id="material_description_'+counter+'" name="material_description[]"></td>',
            '<td><input type="text" data-row_id ="'+counter+'" data-name="buom" id="buom_'+counter+'" name="buom[]" readonly></td>',
            '<td><input type="text" data-row_id ="'+counter+'" data-name="qty" id="qty_'+counter+'" name="qty[]"></td>',
    ...
    $('#store_order_submit').on('click', function () {  
          var table_data = table.$('input').serialize();
