            ...
            <table id="order_detail" class="table table-striped table-bordered example search_data text-center">
              ...
              <tbody>
                  ...
                  @endif
                      ...
                      <td><input type="text" class="material_data form-control h_1rem" data-row_id="{{$key}}" data-name="nupco_desc" id="nupco_desc_{{$key}}" name="nupco_desc[]" value="{{$val->material_desc}}" autocomplete="off"><div id="nupco_generic_code_list_{{$key}}" class="position-relative"></div></td>
