...
<div class="container-fluid main_content bg-white p-2">
    <div class="row mx-0">
        <div class="col-10 text-center">
            <h5 style="color: steelblue"><b>Own Stock Report</b></h5>
        </div>
        ...
        <table class="table table-borderless head_table text-center mb-0 mb-3">
            ...
            <form id="search_stock_form">
                <tr>
                    ...
                    <th width="14%" class="p-0"> <input type="text" class="form-control form-control-sm" name="plant" value="{{Auth::user()->hss_master_no}}" readonly placeholder="Supplying Warehouse" required></th>
                    <!-- <th width="2%" class="p-0">&ensp;</th>
                    <th width="20%" class="p-0"><input type="text" class="form-control form-control-sm" name="storage_location" value="{{Auth::user()->hss_master_no}}" readonly placeholder="Storage Location" required></th> -->
                    <th width="2%" class="p-0">&ensp;</th>
...
<script type="text/javascript">
    ...
    $("#search_stock_form").on("submit", function (e) {
        ...
        $.ajax({
            url:"{{ route('hos.own.search.stock') }}",
            headers: {
