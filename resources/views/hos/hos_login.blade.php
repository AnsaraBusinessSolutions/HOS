    ...
    <header>
        <nav class="navbar navbar-expand fixed-top">
            ...
            <ul class="navbar-nav ml-auto group_main">
                ...
                <li class="nav-item mr-3">
                    <a class="nav-link btn btn-default btn-sm text-white bubbly-button btn_logins active" href="{{ route('hos.login') }}">HOS</a>
                </li>
                <li class="nav-item mr-3">
                                    ...
                                    <div class="col-lg-12 ff_mon">
                                        <div class="p-5">
                                            <div class="text-center">
                                                <h1 class="h4 text-danger mb-4 text_shadow"><b>HOS LOGIN</b></h1>
                                            </div>
