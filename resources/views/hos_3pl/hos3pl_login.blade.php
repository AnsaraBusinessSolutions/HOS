    ...
    <header>
        <nav class="navbar navbar-expand fixed-top">
            ...
            <ul class="navbar-nav ml-auto group_main">
                ...
                <li class="nav-item mr-3">
                    <a class="nav-link btn btn-default btn-sm text-white bubbly-button btn_logins active" href="{{ route('hos3pl.login') }}">3PL</a>
                </li>
                <li class="nav-item mr-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 ff_mon">
                                        <div class="p-5">
                                            ...
                                            <form class="user" method="POST" action="{{ route('hos3pl.login') }}"
                                                aria-label="{{ __('Login') }}">
                                                @csrf
