...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ URL::asset('assets/images/favicon.png') }}" sizes="194x194">
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/lib/style.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/lib/style2.css') }}">
  <!--------table style lib------------------------>
  ...
  <nav class="navbar fixed-top navbar-light bg-white topnav px-2 py-0" style="height: 108px;">
   <div class="col-3">
       <a class="navbar-brand py-3" href="store_order.html">
         <img src="{{ URL::asset('assets/images/king.jpg') }}" height="70px" width="auto">
       </a>
   </div>
    <div class="col-6 text-center px-0">
      <h4 class="text-danger ff_mon">
        <img class="" src="{{ URL::asset('assets/images/HOS-logo.png') }}" style="width:auto;height: 30px"><br>
        <b>NUPCO HOSPITAL ORDERING PORTAL</b></h4>
    </div>
    <div class="col-3 text-right px-0" style="font-size: 11px;font-weight: 600;"> 
      <div class="row">
         <div class="col-12 text-center">
           <img class="" src="{{ URL::asset('assets/images/logo2.png') }}" height="50px" width="auto" style="margin:16px 10px">
         </div>
      </div>
        <!-- <span class="dropdown">
    ...
    <div class="sidenav px-0 mt-2 bg-grey">
      ...
      <ul class="navbar-nav">
        <li class="nav-item my-1 active">
          <a class="nav-link" href="store_order.html">
        ...
        <div class="row mx-0">
          ...
          <div class="col-12 text-center">
            <table id="example" class="table table-striped table-bordered">
              ...
              <tbody>
                  <tr>
                      <td><input type="number" id="item" value=""></td>
                      <td><input type="text" id="nmat" value=""></td>
                      <td><input type="text" id="ccode" value=""></td>
                      <td><input type="text" id="desc" value=""></td>
                      <td><input type="text" id="uom" value=""></td>
                      <td><input type="text" id="qty" value=""></td>
                      <td><input type="text" id="ava" value=""></td>
                  </tr>                 
              </tbody>
            </table>
          </div>
...
<!-- script files -->
  ...
  <script src="{{ URL::asset('assets/lib/crs.min.js') }}"></script>
  <script src="{{ URL::asset('assets/lib/script.js') }}"></script>
  <!--------table style lib------------------------>
  ...
  <script type="text/javascript">
    $("#item").change(function(){
      var item=$("#item").val();
        $.ajax({
                type: "post", url: "{{ url('/item')}}", data: {_token: token,item: item},success: function (data) {
                  if(data!=''){
                    $("#nmat").val(data.a);
                    $("#ccode").val(data.b);
                    $("#desc").val(data.c);
