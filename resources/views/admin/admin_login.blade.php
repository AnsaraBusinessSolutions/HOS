...
<head>
  ...
  <link rel="icon" type="image/png" href="{{ asset('admin/img/logo.png') }}" sizes="194x194">
  ...
  <link href="{{ asset('admin/css/style2.min.css') }}" rel="stylesheet">
...
<body class="bg-gradient-primary">
  ...
  <script src="{{ asset('admin/js/script2.min.js') }}"></script>
